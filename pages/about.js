		...
		<div>
			...
			<div className={styles.wrapper}>
				<div className={styles.hero}>
					<Shader  opacity={0.4}/>
					<img src="/images/about_hero.webp" alt="hero" id="animation-image2"/>
					<h1>Our Team</h1>
				</div>
				<div className={styles.sections} >
					<div className={styles.section1}>
						...
						<img src="/images/about_one.webp" alt="staff" />
					</div>
					<div className={styles.section2}>
						...
						<ul>
							<li>
								<img src="/images/about_person1.webp" alt="person1" />
							</li>
							<li>
								<img src="/images/about_person2.webp" alt="person1" />
							</li>
						</ul>
					</div>
				</div>
				<TwoColSection title="A multidisciplinary approach" img="/images/about1.webp" position="left">
				...
				<TwoColSection title="A team of experienced event and hospitality professionals" img="/images/about2.webp" position="right">
				...
				<TwoColSection title="The face of the function" img="/images/about3.webp" position="left">
