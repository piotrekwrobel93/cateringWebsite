	...
	return(
		<div className={styles.wrapper}>
			...
			<div className={styles.hero}>
				<Shader opacity="0.3" />
				<img  id="animation__wrapper" src="/images/food-hero1.jpg" alt="Hero img" className={styles.hero__image} />
			...
			<div className={styles.swiper}>
				...
				pagination autoplay={{ delay: 1000}} speed={500} loop="true">
					...
					<SwiperSlide><img src="/images/slide3.jpg" alt="slide2" /></SwiperSlide>
				</Swiper>
			</div>
			...
			<div className={styles.presentation__section1}>
				<img src="/images/presentation_section1.jpg" alt="section1" />
				<div>
			...
			<div className={styles.presentation__section2}>
				...
				<img src="/images/presentation_section2.jpg" alt="section1" />
			</div>
